 ...
 * 
 */
public interface MultiTableBatchWriter extends GenericMultiTableBatchWriter<Entry<Key, Value>, Text, Text, Text, Text, Long, Value>{
  
  /*
   * (non-Javadoc)
   * @see org.apache.accumulo.core.client.GenericMultiTableBatchWriter#getBatchWriter(java.lang.String)
   */
