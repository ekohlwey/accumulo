...
public class GenericScannerIterator<T> implements Iterator<T> {
  
  private static final Logger log = Logger.getLogger(GenericScannerIterator.class);
  ...
  private GenericScannerOptions<T,?,?> options;
  ...
  GenericScannerIterator(Instance instance, TCredentials credentials, Text table, Authorizations authorizations, Range range, int size, long l,
      GenericScannerImpl<T, ?, ?> genericScannerImpl, boolean isolated, EntryConverter<T, ?, ?> converter) {
    ...
    this.options = new GenericScannerOptions(genericScannerImpl);
    ...
    scanState = new ScanState(credentials, tableId, authorizations, new Range(range), genericScannerImpl.fetchedColumns, size, genericScannerImpl.serverSideIteratorList,
        genericScannerImpl.serverSideIteratorOptions, isolated);
