...
public class GenericMultiTableBatchWriterImpl implements MultiTableBatchWriter {
  static final Logger log = Logger.getLogger(GenericMultiTableBatchWriterImpl.class);
  ...
  public GenericMultiTableBatchWriterImpl(Instance instance, Credentials credentials, BatchWriterConfig config) {
  ...
  protected void finalize() {
    if (!closed) {
      log.warn(GenericMultiTableBatchWriterImpl.class.getSimpleName() + " not shutdown; did you forget to call close()?");
      try {
        close();
      } catch (MutationsRejectedException mre) {
        log.error(GenericMultiTableBatchWriterImpl.class.getSimpleName() + " internal error.", mre);
        throw new RuntimeException("Exception when closing " + GenericMultiTableBatchWriterImpl.class.getSimpleName(), mre);
      }
    }
  }
