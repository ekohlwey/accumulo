 ...
 * 
 */
public interface GenericMultiTableBatchWriter<TYPE, ROW, FAMILY, QUALIFIER, VISIBILITY, TIMESTAMP, VALUE> {
   ...
   */
  public GenericBatchWriter<TYPE, ROW, FAMILY, QUALIFIER, VISIBILITY, TIMESTAMP, VALUE> getBatchWriter(
      String table) throws AccumuloException, AccumuloSecurityException,
