...
public class ScannerIterator<T> implements Iterator<T> {
  ...
  ScannerIterator(Instance instance, TCredentials credentials, Text table, Authorizations authorizations, Range range, int size, long l,
    ...
    this.options = new ScannerOptions(genericScannerImpl);
